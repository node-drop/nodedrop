...
interface EnvironmentStore {
  ...
  selectEnvironment: (environment: EnvironmentType | null) => void;
  createEnvironment: (
    workflowId: string,
    ...
    persist(
      (set, get) => ({
        ...
        setWorkflow: (workflowId: string) => {
          ...
          // Only reset state if switching to a different workflow
        ...
        selectEnvironment: (environment: EnvironmentType | null) => {
      ...
      }),
      {
        ...
        // Only persist the selected environment and current workflow ID
        partialize: (state) => ({
