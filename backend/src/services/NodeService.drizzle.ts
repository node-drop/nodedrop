...
export class NodeServiceDrizzle {
  private nodeRegistry = new Map<string, NodeDefinition>();
  private secureExecutionService: SecureExecutionService;
  private initializationPromise: Promise<void>;

  constructor() {
    // SecureExecutionService requires a Prisma client but doesn't use it
    // We pass null as a workaround for the Drizzle migration
    this.secureExecutionService = new SecureExecutionService(null as any);
