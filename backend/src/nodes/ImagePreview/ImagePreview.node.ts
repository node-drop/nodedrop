...
export const ImagePreviewNode: NodeDefinition = {
  ...
  ai: {
    description: "Visualizes an image from a URL. Useful if you want to verify image generation or file upload steps.",
    useCases: [
      "Preview an image generated by DALL-E",
      "Verify a file upload URL",
      "Display a user's avatar"
    ],
    tags: ["image", "preview", "visual", "display", "media"],
    rules: [
